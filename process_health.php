<?php
// Direct script to add health check data to the database
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (empty($errors)) {
            ...
            $result = insertData('hive_health', $data);
            
            if ($result) {
                // Set success message
                $_SESSION['message'] = "Health check record added successfully!";
                $_SESSION['message_type'] = "success";
            } else {
                // Set error message
                $_SESSION['message'] = "Failed to add health check record. Please try again.";
        ...
        // Log error
        error_log("Error adding health check record: " . $e->getMessage());
