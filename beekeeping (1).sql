...
--
-- Host: localhost
-- Generation Time: May 10, 2025 at 08:33 AM
...
(2, '1', 'Nakuru', '2025-05-05', 3, 'In good ', 'Inactive', NULL),
(3, '34', 'Kabarak', '2025-05-07', 3, 'good', 'Active', NULL),
(4, '54', 'Kericho', '2025-05-07', 3, 'Good', 'Active', NULL),
(5, '87', 'library', '2025-05-07', 3, 'In good', 'Active', NULL);
...
(14, '', '', 0, 'New', '2025-05-07', '', 'Active'),
(15, '', '', 0, 'New', '2025-05-07', '', 'Active'),
(16, 'Boots', 'Protective Gear', 23, 'New', '2025-05-07', 'good', 'Active'),
(17, 'Boots', 'Protective Gear', 23, 'New', '2025-05-22', 'hgjh', 'Active');
...
(2, 3, '2025-05-10', 1, '5', 'None', 'None', 'good');
...
(4, 2, '2025-05-10', 23.00, 'Wildflower', 'Premium', 'good'),
(5, 2, '2025-05-10', 65.00, 'Wildflower', 'Premium', 'good');
...
(3, 'admin@example.com', '$2y$10$ZGsqrIbLZ1DEMUShOXgwFeFgSQoK1F96FicJnrgxhXLgGw26fianu', 'Admin User', '2025-05-10 01:45:00', '2025-05-10 01:45:00');
...
--
ALTER TABLE `beehive`
  MODIFY `hiveID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `equipment`
  MODIFY `equipmentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `production`
  ADD CONSTRAINT `production_ibfk_1` FOREIGN KEY (`hiveID`) REFERENCES `beehive` (`hiveID`) ON DELETE CASCADE;
